...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    if (!idPedido) {
      console.warn('❌ Webhook sem ID de pedido válido:', JSON.stringify(body, null, 2));
      return;
    }

    console.log(`📦 Webhook gatilho para pedido ${numeroPedido} (ID ${idPedido}). Buscando dados completos via API V3...`);
